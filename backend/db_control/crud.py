...
def myinsert(mymodel, values):
    # Validate customer_id is not empty for Customers model
    if mymodel.__name__ == 'Customers' and ('customer_id' not in values or not values['customer_id'] or values['customer_id'].strip() == ""):
